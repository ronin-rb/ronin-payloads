require 'spec_helper'
require 'ronin/payloads/builtin/shellcode/linux/mips/execve'

describe Ronin::Payloads::Shellcode::Linux::MIPS::Execve do
  ...
  describe ".id" do
    ...
    it "must equal 'shellcode/linux/mips/execve'" do
      expect(subject.id).to eq('shellcode/linux/mips/execve')
    end
  end
