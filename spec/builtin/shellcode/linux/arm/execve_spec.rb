require 'spec_helper'
require 'ronin/payloads/builtin/shellcode/linux/arm/execve'

describe Ronin::Payloads::Shellcode::Linux::ARM::Execve do
  ...
  describe ".id" do
    ...
    it "must equal 'shellcode/linux/arm/execve'" do
      expect(subject.id).to eq('shellcode/linux/arm/execve')
    end
  end
