require 'spec_helper'
require 'ronin/payloads/builtin/shellcode/linux/ppc/execve'

describe Ronin::Payloads::Shellcode::Linux::PPC::Execve do
  ...
  describe ".id" do
    ...
    it "must equal 'shellcode/linux/ppc/execve'" do
      expect(subject.id).to eq('shellcode/linux/ppc/execve')
    end
  end
