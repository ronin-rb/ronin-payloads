require 'spec_helper'
require 'ronin/payloads/builtin/shellcode/freebsd/x86_64/execve'

describe Ronin::Payloads::Shellcode::FreeBSD::X86_64::Execve do
  ...
  describe ".id" do
    ...
    it "must equal 'shellcode/freebsd/x86_64/execve'" do
      expect(subject.id).to eq('shellcode/freebsd/x86_64/execve')
    end
  end
