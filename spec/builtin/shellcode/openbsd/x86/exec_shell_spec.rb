require 'spec_helper'
require 'ronin/payloads/builtin/shellcode/openbsd/x86/exec_shell'

describe Ronin::Payloads::Shellcode::OpenBSD::X86::ExecShell do
  ...
  describe ".id" do
    ...
    it "must equal 'shellcode/openbsd/x86/exec_shell'" do
      expect(subject.id).to eq('shellcode/openbsd/x86/exec_shell')
    end
  end
