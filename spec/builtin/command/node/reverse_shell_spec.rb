require 'spec_helper'
require 'ronin/payloads/builtin/command/node/reverse_shell'

describe Ronin::Payloads::Command::Node::ReverseShell do
  ...
  describe ".id" do
    ...
    it "must equal 'command/node/reverse_shell'" do
      expect(subject.id).to eq('command/node/reverse_shell')
    end
  end
