require 'spec_helper'
require 'ronin/payloads/builtin/command/awk/reverse_shell'

describe Ronin::Payloads::Command::Awk::ReverseShell do
  ...
  describe ".id" do
    ...
    it "must equal 'command/awk/reverse_shell'" do
      expect(subject.id).to eq('command/awk/reverse_shell')
    end
  end
