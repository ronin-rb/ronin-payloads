require 'spec_helper'
require 'ronin/payloads/builtin/command/powershell/reverse_shell'

describe Ronin::Payloads::Command::PowerShell::ReverseShell do
  ...
  describe ".id" do
    ...
    it "must equal 'command/python/reverse_shell'" do
      expect(subject.id).to eq('command/powershell/reverse_shell')
    end
  end
